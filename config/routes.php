...
//Tasks
$router->add('tasks/task', 'tasks/gettask.php', ['GET'])->only('auth'); //create task
$router->add('tasks/task', 'tasks/post_task.php', ['POST'])->only('auth');
$router->add('tasks', 'tasks/tasks.php', ['GET', 'POST', 'DELETE', 'PUT']);   //show all tasks and search tasks by name and id
